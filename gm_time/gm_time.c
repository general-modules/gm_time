 ...
 * @return <0: 失败
 */
static int gm_time_date_time_to_tm(struct tm *system_time, const gm_date_time_t *date_time)
{
    if (system_time == NULL)
    {
        return -1;
 ...
 * @return <0: 失败
 */
static int gm_time_tm_to_date_time(gm_date_time_t *date_time, const struct tm *system_time)
{
    if (date_time == NULL)
    {
        return -1;
 ...
 * @return <0: 失败
 */
static int gm_time_date_time_to_rtc_time(struct rtc_time *rtc_tm, const gm_date_time_t *date_time)
{
    if (rtc_tm == NULL)
    {
        return -1;
 ...
 * @return <0: 失败
 */
static int gm_time_rtc_time_to_date_time(gm_date_time_t *date_time, const struct rtc_time *rtc_tm)
{
    if (date_time == NULL)
    {
        return -1;
...
int gm_time_get_compile_date_time(char *date_time, const size_t len)
{
    if (date_time == NULL)
    {
        return -1;
...
int gm_time_get_system_timezone(char *timezone, const size_t len)
{
    if (timezone == NULL)
    {
        return -1;
...
int gm_time_set_system_timezone(const char *timezone)
{
    if (timezone == NULL)
    {
        return -1;
...
int gm_time_get_date_time_str(char *date_time, const size_t len, const uint8_t gap_flag)
{
    if (date_time == NULL)
    {
        return -1;
...
int gm_time_get_local_time(gm_date_time_t *local_time)
{
    if (local_time == NULL)
    {
        return -1;
    ...
    if (gm_time_tm_to_date_time(local_time, &local_time_system) != 0)
    {
        return -4;
    }
...
int gm_time_set_local_time(const gm_date_time_t *local_time)
{
    if (local_time == NULL)
    {
        return -1;
    ...
    if (gm_time_date_time_to_tm(&new_time, local_time) != 0)
    {
        return -2;
    }
...
int gm_time_get_uptime_ms(uint64_t *uptime_ms)
{
    if (uptime_ms == NULL)
    {
        return -1;
...
int gm_time_convert_unix_to_local(gm_date_time_t *local_time, const uint64_t unix_timestamp_s)
{
    if (local_time == NULL)
    {
        return -1;
...
int gm_time_convert_local_to_unix(uint64_t *unix_timestamp_s, const gm_date_time_t *local_time)
{
    ...
    struct tm local_time_system = {0};
    if (gm_time_date_time_to_tm(&local_time_system, local_time) != 0)
    {
        return -3;
    }
...
int gm_time_set_hardware_clock_from_system_time(const char *device)
{
    if (device == NULL)
    {
        return -1;
    ...
    gm_date_time_t local_time = {0};
    if (gm_time_get_local_time(&local_time) != 0)
    {
        return -2;
    }

    struct rtc_time rtc_tm = {0};
    if (gm_time_date_time_to_rtc_time(&rtc_tm, &local_time) != 0)
    {
        return -3;
    }
...
int gm_time_set_system_time_from_hardware_clock(const char *device)
{
    if (device == NULL)
    {
        return -1;
    ...
    gm_date_time_t local_time = {0};
    if (gm_time_rtc_time_to_date_time(&local_time, &rtc_tm) != 0)
    {
        return -4;
    }

    if (gm_time_set_local_time(&local_time) != 0)
    {
        return -5;
    }
